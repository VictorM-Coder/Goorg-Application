...
public class ActivityCreator implements Creator<Activity> {
    ...
    public Activity createValidItem() {
        return new Activity(1L, "atividade", "descrição", null, null, new PriorityTag("tag"), new Workspace());
    }

    @Override
    public List<Activity> createValidItemsList() {
        List<Activity> list = new ArrayList<Activity>();
        list.add(new Activity(1L, "atividade", "descrição", null, null, null, new Workspace()));
        list.add(new Activity(2L, "atividade2", "descrição", null, null, null, new Workspace()));
        list.add(new Activity(3L, "atividade3", "descrição", null, null, null, new Workspace()));
